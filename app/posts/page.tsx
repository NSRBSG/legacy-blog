      ...
      <div className='flex -m-4 flex-wrap'>
        {posts.map((post) => (
          <Link href={`/posts/${post.id}`} key={post.id}>
            <div className='h-fit m-4 mb-0 md:mb-4 flex flex-col w-[calc(100%-2rem)] md:w-[calc(50%-2rem)] lg:w-[20rem] cursor-pointer bg-white dark:bg-neutral-800 rounded overflow-hidden shadow-lg hover:-translate-y-2 hover:shadow-2xl transition'>
